...
<?php startblock('content'); ?>
	<div class="row">
		<div class="twelvecol last stats by_region">
			<h2>Resumo</h2>
			<p>Totais atualizados em tempo real. Dados referentes ao dia <strong><?php echo Util::formatDate($date, 'd/m/Y à\s H:i:s'); ?></strong></p>
