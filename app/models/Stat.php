...
class Stat extends Model
{
    ...
    public static function findNewVotesPerMinuteByVotacaoId($votacao_id)
    {
        $query = PDOUtils::getConn()->prepare(StatQueries::SQL_FIND_NEW_VOTES_PER_MINUTE_BY_VOTACAO_ID);
        $query->execute(compact('votacao_id'));
