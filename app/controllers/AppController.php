...
class AppController extends Controller
{
    ...
    protected static function setPageName($page_name)
    {
    ...
    protected static function setPageSubName($page_subname)
    {
        self::$page_subname = $page_subname;
    }

    protected static function getPageSubName()
    {
        return self::$page_subname;
    }

    /**
     * @return Regiao
     */
    public static function getRegiao()
    {
        return self::$regiao;
    }
    ...
    public static function flash($flash = NULL, $type = AppException::ERROR)
    {
        if (!($flash instanceof AppException)) {
            if (is_null($flash))
                return !is_null(Session::get('flash'));
            else
                $flash = new AppException($flash, $type);
        }
