 ...
 * EleitorTre
 *
 * @ORM\Table(name="eleitor_tre", uniqueConstraints={@ORM\UniqueConstraint(name="nro_titulo_UNIQUE", columns={"nro_titulo"})}, indexes={@ORM\Index(name="fk_eleitor_tre_municipio", columns={"cod_mun_tre"})})
 * @ORM\Entity
 */
class EleitorTre
{
