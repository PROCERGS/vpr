 ...
 * CedulaOld
 *
 * @ORM\Table(name="cedula_old", indexes={@ORM\Index(name="fk_cedula_votacao", columns={"id_votacao"}), @ORM\Index(name="fk_cedula_regiao", columns={"id_regiao"}), @ORM\Index(name="fk_cedula_grupo_demanda", columns={"id_grupo_demanda"}), @ORM\Index(name="fk_cedula_area_tematica", columns={"id_area_tematica"})})
 * @ORM\Entity
 */
class CedulaOld
{
