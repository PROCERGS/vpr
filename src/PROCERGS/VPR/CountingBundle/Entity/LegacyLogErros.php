 ...
 * LogErros
 *
 * @ORM\Table(name="legacy_log_erros", indexes={@ORM\Index(name="fk_log_erros_cidadao1", columns={"id_cidadao"})})
 * @ORM\Entity
 */
class LegacyLogErros
{
    /**
     * @var integer
     *
     * @ORM\Column(name="id_log_erros", type="integer", nullable=false)
     * @ORM\Id
     ...
     * @var integer
     *
     * @ORM\Column(name="id_cidadao", type="integer", nullable=true)
     */
    private $idCidadao;
