 ...
 * Urna
 *
 * @ORM\Table(name="legacy_urna", indexes={@ORM\Index(name="urna_FKIndex1", columns={"id_votacao"}), @ORM\Index(name="urna_FKIndex2", columns={"id_regiao"}), @ORM\Index(name="urna_FKIndex3", columns={"id_municipio"})})
 * @ORM\Entity
 */
class LegacyUrna
{
